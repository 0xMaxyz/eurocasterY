...
const predictionsByProvider = async function(provider: "farcaster"|"wallet"|"twitter"){
    try {
        const resp = await sql`
SELECT
    COUNT(*) AS predictions
...
const totalPredictionsByProvider = async function(provider: "farcaster"|"wallet"|"twitter"){
    try {
        const resp = await sql`
SELECT
